...
const steps: CheckConfig["steps"] = [
  ...
  inline({
    data: {
      ...
      allowedRootFileStems: ["check", "regex"],
      allowPublicSurfaceReExportChains: false,
      centralSurfacePathPrefixes: ["src/check.ts", "src/quality/index.ts"],
      dependencyPolicies: [
        {
          allowedDependents: [],
        ...
        {
          allowedDependents: ["public-api"],
          allowedRuntimeImporters: [],
          isTypeOnly: false,
          mayDependOn: ["runtime-config", "step", "suite-processing", "types"],
          name: "cli",
        ...
        },
        {
          ...
          allowedRuntimeImporters: [],
          isTypeOnly: false,
          mayDependOn: ["foundation", "timeout", "types"],
          name: "config",
          pathPrefixes: ["src/config", "src/config-schema"],
          surfaceTier: "internal-public",
        },
        {
          allowedDependents: [
          ...
          isTypeOnly: false,
          mayDependOn: ["config", "timeout", "types"],
          name: "runtime-config",
        ...
        },
        {
          ...
          mayDependOn: [],
          name: "foundation",
          pathPrefixes: ["src/foundation", "src/regex.ts"],
          surfaceTier: "internal-public",
        },
        {
          allowedDependents: ["post-process", "public-api", "step"],
          allowedRuntimeImporters: [],
          isTypeOnly: false,
          mayDependOn: ["foundation", "process", "types"],
          name: "inline-ts",
          pathPrefixes: ["src/inline-ts"],
          surfaceTier: "internal-public",
        },
        {
          allowedDependents: [
          ...
          allowedRuntimeImporters: [],
          isTypeOnly: false,
          mayDependOn: ["config", "format", "foundation", "timeout", "types"],
          name: "process",
          pathPrefixes: ["src/process"],
          surfaceTier: "internal-public",
        },
        {
          allowedDependents: ["cli", "public-api", "suite-processing"],
          allowedRuntimeImporters: [],
          isTypeOnly: false,
          mayDependOn: [
            "inline-ts",
          ...
          name: "step",
          pathPrefixes: ["src/step"],
          surfaceTier: "internal-public",
        },
        {
          allowedDependents: ["suite-processing", "public-api"],
          allowedRuntimeImporters: [],
          isTypeOnly: false,
          mayDependOn: [
            "format",
          ...
          name: "post-process",
          pathPrefixes: ["src/post-process"],
          role: "orchestration",
          surfaceTier: "internal-public",
        },
        {
          allowedDependents: ["post-process", "public-api", "suite-processing"],
          allowedRuntimeImporters: [],
          isTypeOnly: false,
          mayDependOn: ["format", "foundation", "runtime-config", "types"],
          name: "summary",
          pathPrefixes: ["src/summary"],
          surfaceTier: "internal-public",
        },
        {
          allowedDependents: ["post-process"],
          allowedRuntimeImporters: [],
          isTypeOnly: false,
          mayDependOn: ["format", "foundation", "types"],
          name: "quality",
          pathPrefixes: ["src/quality"],
          surfaceTier: "internal-public",
        },
        {
          allowedDependents: ["cli", "public-api"],
          allowedRuntimeImporters: [],
          isTypeOnly: false,
          mayDependOn: [
            "format",
          ...
          name: "suite-processing",
          pathPrefixes: ["src/suite-processing"],
          role: "orchestration",
          surfaceTier: "internal-public",
        },
        {
          ...
          allowedRuntimeImporters: [],
          isTypeOnly: false,
          mayDependOn: ["format", "types"],
          name: "timeout",
          pathPrefixes: ["src/timeout"],
          surfaceTier: "internal-public",
        },
        {
          allowedDependents: [
