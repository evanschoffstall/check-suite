...
import type { AliasMapping, CodeRoots } from "@/quality/module-boundaries/foundation/index.ts";

import { normalizePath, trimLeadingDotSlash } from "@/quality/module-boundaries/foundation/index.ts";
