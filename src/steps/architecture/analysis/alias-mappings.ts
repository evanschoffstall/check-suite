...
import type { AliasMapping, CodeRoots } from "@/steps/architecture/foundation/index.ts";

import { normalizePath, trimLeadingDotSlash } from "@/steps/architecture/foundation/index.ts";
